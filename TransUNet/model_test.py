...
parser.add_argument('--checkpoint_path', type=str, default='./checkpoint_enhanced_batch_32/best_tumor_model.pth', help='Path to the trained model checkpoint')
parser.add_argument('--test_list', type=str, default='./lists_kits19/val.txt', help='Path to the test list file')
